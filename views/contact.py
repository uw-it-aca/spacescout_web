...
def thank_you(request):
    ...
    back = _session_variables(request)['back']
    is_mobile = _session_variables(request)['is_mobile']
    return render_to_response('contact-thankyou.html', {'spot_id': spot_id, 'back': back, 'is_mobile': is_mobile, 'ga_tracking_id': ga_tracking_id}, context_instance=RequestContext(request))
...
def sorry(request):
    ...
    return render_to_response('contact-sorry.html', {'spot_id': spot_id, 'back': back, 'email': email, 'is_mobile': is_mobile, 'ga_tracking_id': ga_tracking_id}, context_instance=RequestContext(request))
