...
def sorry(request, spot_id=None):
    ...
    # should maybe do something here ^. raise improperly configured exception
    # if there are no emails in the list in settings.py
    ...
    if spot_id is not None:
        ...
        if 'extended_info' in spot:
            if 'location_description' in spot['extended_info']:
                spot_description = \
                    spot['extended_info']['location_description']
